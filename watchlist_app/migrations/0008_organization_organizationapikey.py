# Generated by Django 5.0.6 on 2024-06-22 21:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='api_keys', to='watchlist_app.organization')),
            ],
            options={
